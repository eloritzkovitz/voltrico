...
class RabbitMQService {
  ...
  private correlationMap = new Map<string, (user: any) => void>();
  ...
  // Request user details via RPC pattern
  async requestUserDetails(userId: string, callback: (user: any) => void) {
  ...
  // Publish a notification after resolving user details
